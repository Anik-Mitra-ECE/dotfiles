...
# ALSO look --> https://github.com/urbainvaes/dotfiles/tree/master/qutebrowser/.local/share/qutebrowser/userscripts
...
#                   Colorscheme                                           #
###########################################################################
## solarized Colorscheme for qutebrowser
solarized = {
    'base03': '#002b36',
    'base02': '#073642',
    'base01': '#586e75',
...
## Type: QssColor
c.colors.completion.even.bg = '#084251'
...
## Type: QssColor
c.colors.statusbar.command.private.bg = solarized['ash']
...
## Type: QssColor
c.colors.statusbar.insert.bg = solarized['crimsblue']
...
## Type: QssColor
c.colors.statusbar.private.bg = solarized['ash']
...
## Crete a "blockedHosts" file in the current directory and
...
## Type: Padding
c.statusbar.padding = {'top': 1, 'bottom': 0, 'left': 0, 'right': 2}
...
c.url.searchengines = {
		...
		'dg': 'https://duckduckgo.com/?q={}&kae=d',
        'dgi': 'https://duckduckgo.com/?q={}&kae=d&iar=images&iax=images&ia=images',
        'gl': 'https://google.com/search?q={}',
        'yt': 'https://www.youtube.com/results?search_query={}',
        'rd': 'https://reddit.com/r/{}',
        'lib': 'https://gen.lib.rus.ec/search.php?req={}',
        'book': 'https://b-ok.cc/s/?q={}',
        'bk': 'https://b-ok.cc/s/?q={}',
        'wd': 'https://en.wiktionary.org/?search={}',
        'we': 'https://en.wikipedia.org/?search={}',
        'wd': 'https://de.wikipedia.org/?search={}',
        'wv': 'https://vim.wikia.com/wiki/Special:Search?fulltext=Search&query={}',
        'wk': 'https://www.wikipedia.org/search-redirect.php?family=wikipedia&language=en&search={}&language=en&go=Go',
        'wu': 'https://wiki.ubuntuusers.de/{}',
        'eb': 'https://ebay.de/sch/{}',
        'am': 'https://amazon.de/s?field-keywords={}',
        'gt': 'https://github.com/search?{}',
        ...
        '8': 'https://8ch.net/{}',
        'etym': 'https://etymonline.com/index.php?allowed_in_frame=0&search={}',
        '4cat': 'https://boards.4chan.org/{}/catalog',
        '8cat': 'https://8ch.net/{}/catalog.html',
        '4': 'https://boards.4chan.org/search#/{}',
...
## Type: List of Perc
c.zoom.levels = ['25%', '33%', '50%', '67%', '75%', '90%', '95','100%','105','110%', '115','125%','135', '150%', '175%', '200%', '250%', '300%', '400%', '500%']
...
config.bind('Db','set-cmd-text -s :quickmark-del')
...
config.bind('T', 'tab-focus')   # Toggle / cycle  between tabs
config.bind('Q', 'quit')
...
config.bind('?',  'open -t qute://help/index.html')
config.bind('f', 'hint')
...
config.bind('wo', 'set-cmd-text -s :open -w') # open in new window
config.bind('ww', 'set-cmd-text -s :open -w')
config.bind('wp', 'open -w -- {clipboard}')
config.bind('xx', 'tab-close')
config.bind('vs', 'config-cycle statusbar.hide')
...
config.bind('Dh', 'history-clear')
config.bind('Dd', 'download-clear')

config.bind('rr', 'reload')
config.bind('<Ctrl-R>', 'reload')

## userscripts
config.bind(",e", 'spawn --userscript explorer')
...
config.bind("dh", 'history-clear')
config.bind("dt", 'set downloads.location.prompt True')
config.bind("df", 'set downloads.location.prompt False')
