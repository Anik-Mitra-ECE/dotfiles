...
# ------------------------------------------------------------
tm_session_name="#[default,bg=$base0E,fg=$base01] #[bold][#S]>> "
set -g status-left "$tm_session_name"

tm_battery="#[bg=$base0D,fg=$base01] #(~/dotfiles/tmux/battery_indicator.sh)"
tm_temp="#[fg=$base01,bg=$base08] #(~/dotfiles/tmux/temp_indicator.sh)"
tm_date="#[default,bg=$base02,fg=$base05] #[bold]%R"
tm_host="#[fg=$base01,bg=$base0E] #h "

set -g status-right "$tm_temp $tm_battery $tm_date $tm_host"
