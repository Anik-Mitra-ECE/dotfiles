...
inoremap <c-s> <Esc>b:wa<CR> 
" instead of Esc, use <c-o> to stay in insert mode after saving
...
set inccommand=split    " Show search and replace commands incrementally in a split window
...
endfun
nnoremap <localleader>cc :call ToggleColorColumn()<CR>
"===================================================="
" for GVIM in windows
...
"===================================================="
" Toggle Wrap
nnoremap <localleader>wt :set wrap!<CR>
" =================================================================
...
augroup languages
  autocmd!
    ...
    autocmd FileType javascript setlocal foldmethod=syntax ts=2 sts=2 sw=2
    autocmd FileType javascript setlocal omnifunc=javascriptcomplete#CompleteJS
    autocmd FileType css setlocal omnifunc=csscomplete#CompleteCSS
...
" =========== =========  abbrebiations =======================================
iabbr myemail mr.robot.me@yandex.com
